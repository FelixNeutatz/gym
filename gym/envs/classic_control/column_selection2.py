...
class ColumnSelectionEnv2(gym.Env):
    metadata = {
    ...
    def load_data(self):
        train_x, train_y = self.read_csv1("/home/felix/SequentialPatternErrorDetection/progress_log_data/distinct/log_progress_blackoak.csv", None)
        ...
        column_matrix_all = column_matrix1
        target_matrix_all = target_matrix1
    ...
    def _reset(self):
        ...
        self.column_ids = -np.ones(self.number_of_columns, dtype=int)
